...
(** Test structurel de add_snake_tail.
    @author Guillaume
    @since 2.0
 *)
let test_add_snake_tail_structural() : unit =
  let test_status : t_test_status = create_test_status("add_snake_tail") and test_matrix : t_matrix = init_snake_matrix() in
  (
    test_matrix.(65).(50) <- SNAKE;
    test_func_equals_value(test_status,"Ajoute une case quand la queue du serpent va à gauche", add_snake_tail, (
                             {dt = {contents = mydt_init()};
                              sn = {contents = [
                                      {pt = {x = 50; y = 50}; dir = LEFT};
                                      {pt = {x = 51; y = 50}; dir = LEFT};
                           ...
                           {dt = {contents = mydt_init()};
                            sn = {contents = [
                                    ...
                                    {pt = {x = 63; y = 50}; dir = LEFT};
                                    {pt = {x = 64; y = 50}; dir = LEFT};
                                    {pt = {x = 65; y = 50}; dir = LEFT}
                                 ]};
                            mat = test_matrix;
                            score={contents =0}});
    test_matrix.(65).(50) <- EMPTY;
    test_matrix.(49).(50) <- SNAKE;
    test_func_equals_value(test_status,"Ajoute une case quand la queue du serpent va à droite", add_snake_tail, (
                             {dt = {contents = mydt_init()};
                              sn = {contents = [
                                      {pt = {x = 64; y = 50}; dir = RIGHT};
                                      {pt = {x = 63; y = 50}; dir = RIGHT};
                                      {pt = {x = 62; y = 50}; dir = RIGHT};
                                      {pt = {x = 61; y = 50}; dir = RIGHT};
                                      {pt = {x = 60; y = 50}; dir = RIGHT};
                                      {pt = {x = 59; y = 50}; dir = RIGHT};
                                      {pt = {x = 58; y = 50}; dir = RIGHT};
                                      {pt = {x = 57; y = 50}; dir = RIGHT};
                                      {pt = {x = 56; y = 50}; dir = RIGHT};
                                      {pt = {x = 55; y = 50}; dir = RIGHT};
                                      {pt = {x = 54; y = 50}; dir = RIGHT};
                                      {pt = {x = 53; y = 50}; dir = RIGHT};
                                      {pt = {x = 52; y = 50}; dir = RIGHT};
                                      {pt = {x = 51; y = 50}; dir = RIGHT};
                                      {pt = {x = 50; y = 50}; dir = RIGHT}
                                   ]};
                              mat = init_snake_matrix();
                              score={contents =0}}),
                           {dt = {contents = mydt_init()};
                            sn = {contents = [
                                    ...
                                    {pt = {x = 51; y = 50}; dir = RIGHT};
                                    {pt = {x = 50; y = 50}; dir = RIGHT};
                                    {pt = {x = 49; y = 50}; dir = RIGHT}
                                 ]};
                            mat = test_matrix;
                            score={contents =0}});
    test_matrix.(49).(50) <- EMPTY;
    test_matrix.().() <- SNAKE;
  )
;;
test_add_snake_tail_structural();;
